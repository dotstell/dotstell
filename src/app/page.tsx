  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', background: 'var(--background)', color: 'var(--foreground)', fontFamily: '-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif', overflowX: 'hidden' }}>
        ...
        <section style={{ padding: '80px 32px 100px', position: 'relative', overflow: 'hidden' }}>
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <a href="https://github.com/dotstell" target="_blank" rel="noopener noreferrer" className="btn-ghost" style={{ fontSize: 15 }}>
        ...
        {/* ── FOOTER ── */}
        <footer style={{ borderTop: '1px solid rgba(255,255,255,0.06)', background: 'rgba(6,6,16,0.8)' }}>
          <div style={{ maxWidth: 1120, margin: '0 auto', padding: '64px 32px 40px' }}>
            ...
            <div className="footer-grid" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 40, marginBottom: 56 }}>
              ...
              <div>
                ...
                <p style={{ fontSize: 13.5, color: 'rgba(200,200,220,0.4)', lineHeight: 1.7, margin: '16px 0 24px', maxWidth: 240 }}>
                  Every dot tells a story. Open source tools for thinking, connecting and remembering.
                </p>
                {/* Social icons */}
                <div style={{ display: 'flex', gap: 10 }}>
                  {/* GitHub */}
                  <a href="https://github.com/dotstell" target="_blank" rel="noopener noreferrer" title="GitHub" style={{
                    width: 34, height: 34, borderRadius: 8, border: '1px solid rgba(255,255,255,0.1)',
                    background: 'rgba(255,255,255,0.04)', display: 'flex', alignItems: 'center', justifyContent: 'center',
                    color: 'rgba(200,200,220,0.5)', textDecoration: 'none', transition: 'border-color .15s, color .15s, background .15s',
                  }}
                    onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(124,106,255,.5)'; (e.currentTarget as HTMLElement).style.color = '#a090ff'; (e.currentTarget as HTMLElement).style.background = 'rgba(124,106,255,.1)' }}
                    onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(255,255,255,.1)'; (e.currentTarget as HTMLElement).style.color = 'rgba(200,200,220,.5)'; (e.currentTarget as HTMLElement).style.background = 'rgba(255,255,255,.04)' }}
                  >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
                  </a>
                  {/* X / Twitter */}
                  <a href="https://x.com/dotstell_labs" target="_blank" rel="noopener noreferrer" title="X (Twitter)" style={{
                    width: 34, height: 34, borderRadius: 8, border: '1px solid rgba(255,255,255,0.1)',
                    background: 'rgba(255,255,255,0.04)', display: 'flex', alignItems: 'center', justifyContent: 'center',
                    color: 'rgba(200,200,220,0.5)', textDecoration: 'none', transition: 'border-color .15s, color .15s, background .15s',
                  }}
              ...
              {/* Product */}
              <div>
                <div style={{ fontSize: 11, fontWeight: 700, color: 'rgba(200,200,220,0.3)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 18 }}>Product</div>
                {[
                  ...
                  <a key={l.label} href={l.href} style={{ display: 'block', fontSize: 13.5, color: 'rgba(200,200,220,0.5)', textDecoration: 'none', marginBottom: 11, transition: 'color .15s' }}
                    onMouseEnter={e => (e.currentTarget.style.color = '#a090ff')}
                    onMouseLeave={e => (e.currentTarget.style.color = 'rgba(200,200,220,0.5)')}
                  >{l.label}</a>
                ))}
              </div>
              ...
              {/* Open Source */}
              <div>
                <div style={{ fontSize: 11, fontWeight: 700, color: 'rgba(200,200,220,0.3)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 18 }}>Open Source</div>
                {[
                  { label: 'GitHub', href: 'https://github.com/dotstell' },
                  { label: 'Contributing', href: 'https://github.com/dotstell/dotstell/blob/main/CONTRIBUTING.md' },
                  { label: 'AGPL-3.0 License', href: 'https://github.com/dotstell/dotstell/blob/main/LICENSE' },
                  { label: 'Security', href: 'https://github.com/dotstell/dotstell/security' },
                  { label: 'Releases', href: 'https://github.com/dotstell/dotstell/releases' },
                ].map(l => (
                  <a key={l.label} href={l.href} target="_blank" rel="noopener noreferrer" style={{ display: 'block', fontSize: 13.5, color: 'rgba(200,200,220,0.5)', textDecoration: 'none', marginBottom: 11, transition: 'color .15s' }}
                    onMouseEnter={e => (e.currentTarget.style.color = '#a090ff')}
                    onMouseLeave={e => (e.currentTarget.style.color = 'rgba(200,200,220,0.5)')}
                  >{l.label}</a>
                ))}
              ...
              {/* Community */}
              <div>
                <div style={{ fontSize: 11, fontWeight: 700, color: 'rgba(200,200,220,0.3)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 18 }}>Community</div>
                {[
                  { label: 'GitHub Discussions', href: 'https://github.com/dotstell/dotstell/discussions' },
                  { label: 'X / Twitter', href: 'https://x.com/dotstell_labs' },
                  { label: 'Report a bug', href: 'https://github.com/dotstell/dotstell/issues/new?template=bug_report.md' },
                  { label: 'Request a feature', href: 'https://github.com/dotstell/dotstell/issues/new?template=feature_request.md' },
                ].map(l => (
                  <a key={l.label} href={l.href} target="_blank" rel="noopener noreferrer" style={{ display: 'block', fontSize: 13.5, color: 'rgba(200,200,220,0.5)', textDecoration: 'none', marginBottom: 11, transition: 'color .15s' }}
                    onMouseEnter={e => (e.currentTarget.style.color = '#a090ff')}
                    onMouseLeave={e => (e.currentTarget.style.color = 'rgba(200,200,220,0.5)')}
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
              ...
              <div style={{ display: 'flex', gap: 20 }}>
                {[
                  ...
                  <a key={l.label} href={l.href} style={{ fontSize: 12, color: 'rgba(200,200,220,0.3)', textDecoration: 'none', transition: 'color .15s' }}
